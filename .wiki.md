...
- **src/components/BotInterface.tsx**: Interface for configuring trading bots, now includes persistent settings via localStorage, device management, and continuous data collection.
...
- **src/contexts/AuthContext.tsx**: Provides authentication context and state management, updated to remove a 404-causing API call.
