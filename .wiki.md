...
- **src/components/BotInterface.tsx**: Interface for configuring trading bots with persistent settings via localStorage, device management, and continuous data collection.
